...
export default function VerifyEmail() {
  return (
    <div className="min-h-screen bg-mist dark:bg-[#030712] flex items-center justify-center p-4 animate-fade-in transition-colors duration-300">
      <div className="w-full max-w-md bg-white dark:bg-slate-900 border border-boundary dark:border-slate-800 rounded-2xl shadow-card p-8 text-center">
        <Link href="/" className="font-serif text-2xl text-ink dark:text-white inline-block mb-6">ResumOrph</Link>
        <div className="w-16 h-16 bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-indigo-400 rounded-full flex items-center justify-center mx-auto mb-6">
        ...
        <h2 className="font-serif text-2xl text-ink dark:text-white font-bold mb-2">Check Your Inbox</h2>
        <p className="text-sm text-graphite dark:text-slate-400 mb-6 leading-relaxed">
