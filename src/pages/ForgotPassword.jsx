    ...
    <div className="min-h-screen bg-[#0B0F19] text-slate-200 flex items-center justify-center p-4 relative overflow-hidden select-none font-sans animate-fade-in">
      ...
      <GlassPanel className="w-full max-w-md border-slate-800/80 bg-slate-900/45 backdrop-blur-xl p-8 sm:p-10 shadow-2xl relative z-10">
        ...
        <div className="mb-6 text-center">
          <Link to="/" className="inline-flex items-center gap-2 font-serif text-2xl font-bold text-white tracking-tight mb-4">
        ...
        {sent ? (
          <div className="text-center animate-fade-in">
            ...
            <div className="bg-indigo-950/40 border border-indigo-850/50 text-indigo-300 rounded-xl p-4 mb-6 text-xs leading-relaxed text-left font-medium">
          ...
          <form onSubmit={handleReset} className="flex flex-col gap-5">
            ...
            <Link to="/login" className="flex items-center justify-center gap-1.5 text-xs font-bold text-slate-450 hover:text-white transition-colors mt-2">
              <ArrowLeft size={13} />
              Back to Login
            </Link>
          </form>
